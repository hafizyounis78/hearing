                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <select name="R_TEST_TYPE" id="R_TEST_TYPE" class="col-8 form-control"
                                            onchange="get_test_result_recom_list();">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <a type="button" class="btn btn-secondary"
                                           href="<?php echo base_url('index.php/patient_cont/referral_patient_list'); ?>">
                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-bordered table-advance table-hover" >
                                            ...
                                            <tr>
                                                ...
                                                <th width="15%" class="bold" style="text-align: center">Test Type</th>
                                                <th width="10%" class="bold" style="text-align: center">Result</th>
                                                <th width="20%" class="bold" style="text-align: center">Recommendation
                                                </th><!--ظهر فقط في حالة نو عالفحص APR -->
                                                <th width="15%" class="bold" style="text-align: center">Note</th>
                                            ...
                                            <tbody id="tbscreening" style="text-align: left">
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
