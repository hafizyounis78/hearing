...
<script>
                    ...
                    render: function (data, type, full, meta) {
                        if (full.VISIT_ATTEND_CD == 108)
                            return '<span class="dropdown"><a href="#" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="dropdown" aria-expanded="true">' +
                                ...
                                '<a class="dropdown-item" href="javascript:;" onclick="open_risk_vw(' + data + ')"><i class="la la-archive"></i> Risk factor</a>' +
                                '<a class="dropdown-item" href="javascript:;" onclick="open_screening_vw(' + data + ')"><i class="la la-leaf"></i> Screening</a>' +
                                '<a class="dropdown-item" href="javascript:;" onclick="open_referral_vw(' + data + ')"><i class="flaticon-reply"></i> Referral</a>' +
                                '<a class="dropdown-item" href="javascript:;" onclick="open_calendar(' + data + ')"><i class="flaticon-calendar"></i> New Appointment</a>' +
                                '<a class="dropdown-item" href="javascript:;" onclick="open_doctor_review(' + data + ')"><i class="flaticon-list-2"></i> Patient File</a>' +
                                '</div></span>';
    ...
    function open_doctor_review(visit_id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var url = baseURL + 'doctor_cont/doctor_review';
                window.location.href = url;//+national_id;
