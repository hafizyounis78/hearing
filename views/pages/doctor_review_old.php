                            ...
                            <div class="kt-portlet__body kt-portlet__body--fit-y">
                                ...
                                <div class="kt-widget kt-widget--user-profile-1">
                                    ...
                                    <div class="kt-widget__footer">
                                        <a href="<?php echo base_url('index.php/patientlist_cont/patientlist_doctor_vw'); ?>"
                        ...
                        <div class="row">
                                ...
                                <div class="kt-portlet" dir="ltr">
                                    <div class="kt-portlet__head">
                                        ...
                                        <div class="kt-portlet__head-toolbar">
                                            ...
                                            <a href="#" class="" data-toggle="modal" data-target="#vital_signs_modal"
                            ...
                            <div class="col-xl-12">
                                <div class="kt-portlet" dir="ltr">
                                    <div class="kt-portlet__head">
                                        <div class="kt-portlet__head-label">
                                            <h3 class="kt-portlet__head-title">Risk Factors For HI</h3>
                                        </div>
                                        <div class="kt-portlet__head-toolbar">
                                    ...
                                    <form class="kt-form kt-form--label-right" action="javascript:;" id="kt_form"
                                            ...
                                            <div class="kt-section kt-section--first">
                                                <div class="kt-section__body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Presence of
                                                            family history of permanent hearing impairment</label>
                                                        <div class="col-lg-4 col-xl-4">
                                                            <select class="form-control kt-select2-ltr"
                                                                    id="P_SUSPECTED_COVID" name="P_SUSPECTED_COVID">
                                                                <option value></option>
                                                                <option value="1">Yes</option>
                                                                <option value="2">No</option>
                                                            </select>
                                                        </div>
                                                        <label class="col-xl-1 col-lg-1 col-form-label"> Admission to
                                                            N.I.C.U more than 5 days </label>
                                                        <div class="col-lg-4 col-xl-4">
                                                            <select class="form-control kt-select2-ltr"
                                                                    id="P_SUSPECTED_COVID" name="P_SUSPECTED_COVID">
                                                                <option value></option>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Presence of
                                                            congenital abnormalities of the head or face </label>
                                                        <div class="col-lg-4 col-xl-4">
                                                            <select class="form-control kt-select2-ltr"
                                                                    id="P_SUSPECTED_COVID" name="P_SUSPECTED_COVID">
                                                                <option value></option>
                                                        ...
                                                        <label class="col-xl-1 col-lg-1 col-form-label">Neonatal
                                                            jaundice which required blood exchange </label>
                                                        <div class="col-lg-4 col-xl-4">
                                                            <select class="form-control kt-select2-ltr"
                                                                    id="P_SUSPECTED_COVID" name="P_SUSPECTED_COVID">
                                                                <option value></option>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Gestational
                                                            age </label>
                                                        <div class="col-lg-4 col-xl-4">
                                                            <select class="form-control kt-select2-ltr"
                                                                    id="P_SUSPECTED_COVID" name="P_SUSPECTED_COVID">
                                                        ...
                                                        <label class="col-xl-1 col-lg-1 col-form-label">Type of
                                                            delivery</label>
                                                        <div class="col-lg-4 col-xl-4">
                                                            <select class="form-control kt-select2-ltr"
                                                                    id="P_SUSPECTED_COVID" name="P_SUSPECTED_COVID">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Consanguinity </label>
                                                        <div class="col-lg-4 col-xl-4">
                                                            <select class="form-control kt-select2-ltr"
                                                                    id="P_SUSPECTED_COVID" name="P_SUSPECTED_COVID">
                                                                <option value></option>
                                                        ...
                                                        <label class="col-xl-1 col-lg-1 col-form-label"> Complications
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-4 col-xl-4">
                                                            <input type="text"
                                                                   class="form-control kt-input kt_datetimepicker P_DISCHARGE_DATE_TIME"
                                                                   disabled name="TOD" id="TOD" placeholder="TOD"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 col-xl-12">
                                                        <button type="submit" class="btn btn-primary"
                                                                onclick="INSERT_DOCTOR_ASSESSMENT();">Save
                                                        </button>&nbsp;
                                                        ...
                                                        <button type="button" class="btn btn-success"
                                                                ...
                                                                aria-haspopup="true" aria-expanded="false">Reffer
                                                        </button>&nbsp;
                                                        <button type="button" class="btn btn-info" data-toggle="modal"
                                                                data-target="#patient_card_modal" aria-haspopup="true">
                                                            Print Patient Card <i class="la la-print"></i></button>&nbsp;
                                                        <button type="button" class="btn btn-info" data-toggle="modal"
                                                                data-target="#referral_report_modal"
                                                                aria-haspopup="true"> Print Referral Report <i
                                                                    class="la la-print"></i></button>
                                                        <button type="button" class="btn btn-danger pull-right"
                                                                data-toggle="modal" data-target="#end_session_modal"
                                                                aria-haspopup="true"> End Session <i
...
<!--begin::Modal-->
<div class="modal fade" id="vital_signs_modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true"
     dir="ltr">
                ...
                <div class="modal-body">
                    <div class="kt-scroll-modal" data-scroll="true" style="height:400px">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <input class="form-control" type="number" id="P_BP_SYSTOLIC" name="P_BP_SYSTOLIC"
                                       value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <input class="form-control" type="number" value="" id="P_BP_DIASTOLIC"
                                       name="P_BP_DIASTOLIC">
                            </div>
                        </div>
                        <div class="form-group row">
