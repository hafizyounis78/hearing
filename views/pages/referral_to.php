    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc"> قائمة المرضى المحولين من العيادة</span>
            </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable"
                            ...
                            <tr>
                                ...
                                <th width="15%">الفحص المطلوب</th>
                                <th width="15%">سبب التحويل</th>
...
<script>
    ...
    function viewTable() {
     ...
     /*   $('#patient_tb').on('error.dt', function (e, settings, techNote, message) {
        ...
        table.DataTable({
            ...
            ajax: {
                "type": "post",
                "url": baseURL + 'Referral_cont/getReferralFromPatient',
                "data": {
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return '<a title="Patient File" onclick="open_patient_file(' + data + ')"  class="btn  btn-clean btn-icon btn-icon" href="javascript:;" ><i class="flaticon2-document"></i></a>';
    ...
    function open_patient_file(visit_id) {
