...
<!-- end:: Content -->
		...
		<form class="kt-form kt-form--fit" action="javascript:;">
			<div class="row kt-margin-b-20">
                ...
                <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
					<label>المركز:</label>
                    <select class="form-control kt-select2" id="RTC_CENTER_ID" name="RTC_CENTER_ID" data-col-index="3">
			...
			<div class="row">
				<div class="col-lg-12">
					<button class="btn btn-primary btn-brand--icon" onclick="GET_PATIENT_ALL_LIST();">
						<span>
