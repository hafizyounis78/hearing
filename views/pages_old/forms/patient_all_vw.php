                ...
                <div class="col-md-12">
								...
								<div class="kt-subheader   kt-grid__item" id="kt_subheader">
									<div class="kt-subheader__main">
										...
										<span class="kt-subheader__desc">استعلام عام المتابعة المنزلية  </span>
										</div>
		...
		<form class="kt-form kt-form--fit" action="javascript:;">
			<div class="row kt-margin-b-20">
                 ...
                 <div class="kt-form__control">
                        ...
                        <div class="col-3">
                            <input type="text" id="LAST_NAME" name="LAST_NAME" class="form-control" placeholder="اسم العائلة">
                                    ...
                                    <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
					<label>الجهة:</label>
                    <select class="form-control kt-select2" id="P_LOC_ID" name="P_LOC_ID" data-col-index="3">
            	...
            	<div class="row kt-margin-b-20">
                    ...
                    <select class="form-control kt-select2" id="P_COVID" name="P_COVID" data-col-index="3">
<!--                    <option value="">الكل</option>//-->
                    <option value="1">مصاب</option>
                    <option value="2">مخالط</option>
					</select>
				</div>
					...
					<div class="input-daterange input-group" >
						<input type="text" class="form-control kt-input" name="P_FROM_TEM_NUM" id="P_FROM_TEM_NUM" placeholder="من" value="" data-col-index="5"/>
						<div class="input-group-append">
							<span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
						</div>
						<input type="text" class="form-control kt-input" name="P_TO_TEM_NUM" id="P_TO_TEM_NUM" placeholder="حتى" value="" data-col-index="5"/>
					</div>
				</div>
                    
                     <div class="col-lg-2 kt-margin-b-10-tablet-and-mobile">
					<label>مرات التنفس:</label>
					<div class="input-daterange input-group">
						<input type="text" class="form-control kt-input" name="P_FROM_BREATHE_NUM" id="P_FROM_BREATHE_NUM" placeholder="من" value="" data-col-index="5"/>
						<div class="input-group-append">
							<span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
						</div>
						<input type="text" class="form-control kt-input" name="P_TO_BREATHE_NUM" id="P_TO_BREATHE_NUM" placeholder="حتى" value="" data-col-index="5"/>
					</div>
				</div>
					...
					<div class="input-daterange input-group" >
						<input type="text" class="form-control kt-input" name="P_FROM_PULS_NUM" id="P_FROM_PULS_NUM" placeholder="من" value="" data-col-index="5"/>
						<div class="input-group-append">
							<span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
						</div>
						<input type="text" class="form-control kt-input" name="P_TO_PULS_NUM" id="P_TO_PULS_NUM" placeholder="حتى" value="" data-col-index="5"/>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<button class="btn btn-primary btn-brand--icon" onclick="GET_ALL_VISIT_PATIENT();">
						<span>
